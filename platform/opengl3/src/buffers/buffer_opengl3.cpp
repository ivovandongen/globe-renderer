...
constexpr GLenum convert(const renderer::opengl3::BufferTarget& target) {
    using namespace renderer::opengl3;
    switch (target) {
...
constexpr GLenum convert(const renderer::BufferHint& hint) {
